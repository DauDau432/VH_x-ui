...
install_x-ui() {
    ...
    echo -e ""
    echo -e "  Hãy đảm bảo cổng ${green}54321${plain} không bị các chương trình khác chiếm Và Cổng 54321 đã được mở"
    echo -e "  Nếu bạn muốn đổi 54321 thành một cổng khác, hãy nhập lệnh x-ui để đổi và đảm bảo cổng đã đó cũng được mở"
    echo -e ""
